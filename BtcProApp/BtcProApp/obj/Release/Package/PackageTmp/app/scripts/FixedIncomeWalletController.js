...
module.controller('FixedIncomeWallet', function ($scope, $http) {
    ...
    $scope.getCurrentFixedIncome = function () {
        ...
        $http.get('/Home/MyFixedIncomeWallet?WalletId=3').then(function (response) {
...
module.controller('ETHFixedIncomeWallet', function ($scope, $http) {
    // Pagination control related
    $scope.recordCount = 0;
    $scope.currentPage = 1;
    $scope.startindex = 0;
    ...
    $scope.getCurrentFixedIncome = function () {
        ...
        $http.get('/Home/MyFixedIncomeWallet?WalletId=6').then(function (response) {
            $scope.FixedWalletledger = response.data.FixedWallet;
